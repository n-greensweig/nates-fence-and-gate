...
function About() {
  ...
  // Set a stable canonical URL in production; fallback to window.location.href in development.
  const canonicalUrl =
    process.env.NODE_ENV === "production"
      ? "https://www.natesfenceandgate.com/about"
  ...
  return (
    <div className="w-screen">
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about Nate's Fence and Gate: our goal, standards, and why we use galvanized steel posts for a unique and affordable fence experience."
        />
      ...
      <div className="pt-10">
        <h1 className="text-3xl mb-10">
          <strong>Why we use galvanized steel posts:</strong>
        </h1>
